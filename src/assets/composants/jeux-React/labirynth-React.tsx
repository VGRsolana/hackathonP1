...
import Popup from './pop-up-React.tsx';
...
const grille = [
    ['start', 'path',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall'],
    ['wall',  'path',  'path',  'path',  'path',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall'],
    ['wall',  'wall',  'wall',  'wall',  'path',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall'],
    ['wall',  'wall',  'wall',  'wall',  'path',  'path',  'path',  'path',  'path',  'path',  'wall',  'wall',  'wall',  'wall',  'wall'],
    ['wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'path',  'wall',  'wall',  'wall',  'wall',  'wall'],
    ['wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'wall',  'path',  'path',  'path',  'path',  'path',  'wall'],
